...
public class GlueExpressionUtil
{
    ...
    private static final List<String> QUOTED_TYPES = ImmutableList.of("string", "char", "varchar", "date", "timestamp");
    ...
    {
        return QUOTED_TYPES.contains(type.getTypeInfo().getTypeName());
    }
}
