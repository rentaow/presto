...
public class TestGlueInputConverter
{
    ...
    private void assertColumnList(List<com.amazonaws.services.glue.model.Column> actual, List<Column> expected)
    {
        if (expected == null) {
            assertNull(actual);
        }
    ...
    private void assertColumn(com.amazonaws.services.glue.model.Column actual, Column expected)
    {
    ...
    private void assertStorage(StorageDescriptor actual, Storage expected)
    {
