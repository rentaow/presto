...
public class TestMetastoreObjects
{
    ...
    public static Table getGlueTestTable(String dbName)
    {
        return new Table()
                ...
                .withName("test-tbl" + generateUUID())
                .withOwner("owner")
                .withParameters(ImmutableMap.of())
    ...
    {
        return new Column()
                .withName("test-col" + generateUUID())
                .withType("string")
    ...
    public static com.facebook.presto.hive.metastore.Database getPrestoTestDatabase()
    {
        return com.facebook.presto.hive.metastore.Database.builder()
                .setDatabaseName("test-db" + generateUUID())
    ...
    public static com.facebook.presto.hive.metastore.Table getPrestoTestTable(String dbName)
    {
        return com.facebook.presto.hive.metastore.Table.builder()
                ...
                .setTableName("test-tbl" + generateUUID())
                .setOwner("owner")
                .setParameters(ImmutableMap.of())
    ...
    {
        return new com.facebook.presto.hive.metastore.Column("test-col" + generateUUID(), HiveType.HIVE_STRING, Optional.of("column comment"));
    }
    ...
    {
        return UUID.randomUUID().toString().replaceAll("[^a-zA-Z0-9]+", "").substring(0, 4);
    }
}
